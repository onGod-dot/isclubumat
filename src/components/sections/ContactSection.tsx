        ...
        <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div className="space-y-5">
              {[
                ...
                <div key={c.label} className="flex items-start gap-4">
                  ...
                  <a href={c.href} className="text-sm text-gray-800 hover:text-[color:var(--club-blue-deep)] transition leading-relaxed">{c.value}</a>
                </div>
              ))}
            </div>
            ...
            <div className="mt-10 flex items-center gap-4">
              {[
                ...
                <a
                  key={s.name}
                  href={s.href}
                  className="text-xs font-semibold text-gray-500 hover:text-[color:var(--club-blue-deep)] transition"
                >
                  {s.name}
                </a>
              ))}
          ...
          <div className="bg-white border border-gray-100 rounded-2xl p-8">
            <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
              ...
              <button
                type="submit"
                className="w-full rounded-xl py-3 text-sm font-bold text-white bg-[color:var(--club-blue-deep)] hover:bg-black transition-colors duration-150"
              >
                Send Message
              </button>
            </form>
